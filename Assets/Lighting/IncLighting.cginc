...
fixed4 frag (v2f i) : SV_Target
{
    ...
    float3 L = normalize(UnityWorldSpaceLightDir(i.worldPosition));// _WorldSpaceLightPos0.xyz; //actually a direction to the light source
    ...
    //float fresnel = step(0.6,(1 - dot(V,N)));// * (cos(_Time.y * 4)) * _Mag + _Str;
